...
function App() {
  ...
  const names = [
    ...
    { key: 'baraka', label: 'LeRoi Jones' },
    { key: 'truth', label: 'Isabella Baumfree' },
    { key: 'douglass', label: 'Frederick Bailey' },
    { key: 'afeni', label: 'Alice Faye Williams' },
  ...
  const descriptions = {
    ...
    baraka: "<strong> AMIRI BARAKA. </strong>",
    truth: "<strong> SOJOURNER TRUTH. </strong>",
    douglass: "<strong> FREDERICK DOUGLASS. </strong>",
    afeni: "<strong> AFENI SHAKUR. </strong>",
